...
export function createSecureIframe(url, title = 'Game Stream') {
  ...
  // Mobile: sandbox blocks redirects/popups (ads). The embed doesn't check
  // for sandbox on mobile browsers.
  // Desktop: no sandbox — the embed detects it and refuses to play.
  // Instead, the guard.js handles desktop ad protection via JS interception.
